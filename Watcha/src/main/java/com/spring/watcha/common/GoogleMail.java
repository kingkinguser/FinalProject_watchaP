...
public class GoogleMail {
	...
	public void sendmail(String recipient, Map<String, String> paraMap) throws Exception {
        ...
        prop.put("mail.smtp.user", "shichae01@gmail.com");
        ...
        msg.setContent("<div id=\":n7\" class=\"ii gt\" jslog=\"20277; u014N:xr6bB; 1:WyIjdGhyZWFkLWY6MTc2ODY2NjY0MzYxMjc0NTI0OCIsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsW11d; 4:WyIjbXNnLWY6MTc2ODY2NjkwNTA0NDA1Mzg3NSIsbnVsbCxbXV0.\"><div id=\":ml\" class=\"a3s aiL msg-8577157101898078949 adM\"><div class=\"HOEnZb\"><div class=\"adm\"><div id=\"q_11\" class=\"ajR h4\" data-tooltip=\"펼쳐진 본문 숨기기\" aria-label=\"펼쳐진 본문 숨기기\" aria-expanded=\"true\"><div class=\"ajT\"></div></div></div><div class=\"im\"><u></u> " + 
        		...
        		"          <p style=\"margin:8px 0\">© 2023. <a href=\""+paraMap.get("ctxPath")+"/main.action\" style=\"color:#fc426a\" target=\"_blank\" data-saferedirecturl=\"https://www.google.com/url?q=https://mandrillapp.com/track/click/30020511/team.watcha.com?p%&amp;source=gmail&amp;ust=1686944943217000&amp;usg=AOvVaw1uJ_NdybT69slausZ0YTtF\">Watcha, Inc.</a> All rights reserved.</p> " + 
	...
	public void sendmail_OrderFinish(String recipient, String name, String emailContents)   throws Exception {
        ...
        // 보내는 사람의 메일주소
        String sender = "shichae01@gmail.com";
        Address fromAddr = new InternetAddress(sender);
        msg.setFrom(fromAddr);
